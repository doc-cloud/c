...
/* the last data show twice, and program cannot exit */
...
*/
	...
	if (-1 == bind(sock_recv, (struct sockaddr *)&addr_recv, sizeof(addr_recv)))
	...
	setsockopt(sock_recv, IPPROTO_IP, IP_ADD_MEMBERSHIP, (void *)&join_addr,
		   sizeof(join_addr));
